...
import com.tans.tuiutils.dialog.showContinuationStateCancelableResultDialogFragment
import com.tans.tuiutils.dialog.showContinuationStateForceResultDialogFragment
...
class MainActivity : BaseCoroutineStateActivity<Unit>(Unit) {
    ...
    override fun bindContentView(contentView: View) {
        ...
        viewBinding.transparentSystemBarActBt.clicks(lifecycleScope) {
            startActivity(Intent(this@MainActivity, TransparentSystemBarActivity::class.java))
        }

        viewBinding.fitSystemWindowActBt.clicks(lifecycleScope) {
            startActivity(Intent(this@MainActivity, FitSystemWindowActivity::class.java))
        }

        viewBinding.fullScreenActBt.clicks(lifecycleScope) {
            startActivity(Intent(this@MainActivity, FullScreenActivity::class.java))
        }

        viewBinding.yesOrNoDialogBt.clicks(lifecycleScope) {
            runCatching {
                this@MainActivity.supportFragmentManager.showContinuationStateForceResultDialogFragment(YesOrNoDialog())
            }.onSuccess {
        ...
        viewBinding.selectAudiosBt.clicks(lifecycleScope) {
            ...
            runCatching { this@MainActivity.permissionsRequestSimplifySuspend(*audioReadPermission) }
                .onSuccess {
                    if (it) {
                        val selectedAudios = this@MainActivity.supportFragmentManager.showContinuationStateCancelableResultDialogFragment(AudioSelectDialog())
        ...
        viewBinding.takeAPhotoBt.clicks(lifecycleScope) {
        ...
        viewBinding.pickAPictureBt.clicks(lifecycleScope) {
        ...
        viewBinding.fragmentActBt.clicks(lifecycleScope) {
            startActivity(Intent(this@MainActivity, MyFragmentActivity::class.java))
        }

        viewBinding.mediaStoreActBt.clicks(lifecycleScope) {
